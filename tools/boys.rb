...
# set up the grid
# T. Helgekar says the asymtotic formula works well for x > 19.35
...
# argument array constructor, so we have to use assigment via data.
# This means we cannot set the grid as parameter
